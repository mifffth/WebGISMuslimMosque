...
<body id="page-top">
                ...
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="geoserver.html">WebMap</a>
                            <a class="dropdown-item"
                                href="https://youtu.be/Hj5cZp-yaXw?si=Xc_G1wNF0-syaVWa">Cinematic</a>
                        </div>
                    </li>
                    <!-- End Dropdown Button -->
                </ul>
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="img/img/portfolio/fullsize/1.jpg">
                    <img class="img-fluid" src="{{ asset('img/portfolio/thumbnails/a.jpg') }}" alt="..." />
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Jumlah Masjid, Mushola, dan Langgar di Kabupaten Sleman per Tahun 2022</h5>
            </div>
            <div class="card-body">
                <div id="chart"></div>
            </div>
    ...
    <section class="page-section bg-dark text-white">
        <div class="container px-4 px-lg-5 text-center">
            ...
            <a class="btn btn-light btn-xl" href="geoserver.html">Klik disini!</a>
        </div>
    </section>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/5.3.2/js/bootstrap.min.js"
        integrity="sha384-cBzAV4WjUZdAdq7xQacRAgT2YKGgE3azN6l1ZPcypdSA2NcFqQ6pIZ1aZYo5lFfB"
